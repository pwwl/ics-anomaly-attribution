...
- [explain-eval-attacks](#): 
    - `main_bbox_explain_attacks.py`:
    - `main_grad_explain_attacks.py`:
...
- [explain-eval-manipulations](#):
    - `main_bbox_explain_manipulations.py`:
    - `main_tep_grad_explain.py`:
...
- Primary Workflow Scripts
    - `main_feature_properties.py`:
    - `main_feature_properties_tep.py`:
    - `main_train.py`:
    - `save_detection_points.py`:
    - `save_model_mses.py`:
- Additional Scripts
